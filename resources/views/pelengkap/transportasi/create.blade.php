...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Tambah Transportasi
                    <div class="page-title-subheading">
                        Membuat transportasi yang baru
                    </div>
                </div>
            </div>  
        </div> 
    ...
    <div class="main-card card">
        ...
        <div class="card-body">
            <form  method="post" action="{{route('transportasi.store')}}" id="createForm">
                @csrf
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            <label for="nama_transportasi" class="">Transportasi</label>
                            <input name="nama_transportasi" id="nama_transportasi" placeholder="Masukkan transportasi" type="text" class="form-control @error('nama_transportasi') is-invalid @enderror" value="{{ old('nama_transportasi') }}">
