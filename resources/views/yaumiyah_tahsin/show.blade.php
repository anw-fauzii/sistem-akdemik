        ...
        <div class="main-card card border-0 shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center py-4">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('yaumiyah-tahsin.print', ['tingkat' => $tingkat, 'tanggal' => $tanggalPilih]) }}"
                                        ...
                                        <td class="text-center" style="padding: 0.4rem !important;">
                                            @if ($record)
                                                <div class="cell-card {{ $cardClass }}">
                                                    <div class="jilid-txt"
                                                        title="{{ $record->daftarJilid->jilid_latin ?? ($record->daftarJilid->nama_jilid ?? '-') }}">
                                                        {{ $record->daftarJilid->jilid_latin ?? ($record->daftarJilid->nama_jilid ?? '-') }}
                                                    </div>
                                                    ...
                                                    <div class="hal-txt"
                                                        ...
                                                        @elseif($record->angka_arab_id)
                                                            Hal. {{ $record->angkaArab->id ?? '-' }}
                                                        @else
                                                            -
                                                        @endif
                                                    </div>
