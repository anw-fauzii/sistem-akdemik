                ...
                <div class="page-title-heading">
                    ...
                    <div>Yaumiyah Tahsin
                        <div class="page-title-subheading">
                            Pilih tingkat atau kelompok tahsin Anda untuk mulai mengisi penilaian harian (Yaumiyah).
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right border-0 shadow"
                                                    ...
                                                    <a href="{{ route('yaumiyah-tahsin.create', ['tingkat' => $grup->tingkat]) }}"
                                                    ...
                                                    <a href="{{ route('yaumiyah-tahsin.show', $grup->tingkat) }}"
                                                        class="dropdown-item py-2 mb-1 d-flex align-items-center">
                                                        <i class="fa fa-eye text-info me-3"
                                                            style="width: 20px; text-align: center;"></i>
                                                        <span class="text-dark" style="font-weight: 500;">Detail</span>
                                                    </a>
                                                    <a href="{{ route('yaumiyah-tahsin.statistik', $grup->tingkat) }}"
