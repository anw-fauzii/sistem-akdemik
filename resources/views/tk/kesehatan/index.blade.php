    ...
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Data Kesehatan {{ $kelas->nama_kelas ?? '' }} - {{ $bulanTerbaru->nama_bulan }}
        ...
        <div class="main-card card">
            <div class="card-header">
                @php
                    // Mengecek apakah sudah ada data kesehatan yang terisi dari Eager Loading
                    $belumAdaData = $anggotaKelasList->pluck('dataKesehatan')->filter()->isEmpty();
                @endphp

                <a href="{{ route('data-kesehatan.edit', $bulanTerbaru->id) }}" class="btn btn-primary">
                    {{ $belumAdaData ? 'Tambah Data' : 'Update Data' }}
                </a>

                &nbsp;
                <button class="btn btn-warning dropdown" type="button" id="dropdownMenu2" data-bs-toggle="dropdown"
                    aria-expanded="false">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                    @foreach ($bulan_spp as $bulan)
                        <li>
                            <a href="{{ route('data-kesehatan.show', $bulan->id) }}" class="dropdown-item">
                                {{ $bulan->nama_bulan }}
                            </a>
                        </li>
                    @endforeach
                    ...
                    <table class="mb-0 table table-hover table-striped" id="myTable2">
                        ...
                        <tbody>
                            @foreach ($anggotaKelasList as $anggota)
                                @php
                                    // Mengambil data langsung dari relasi Eager Loading (Sangat Cepat & 0 Query)
