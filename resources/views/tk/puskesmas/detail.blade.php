    ...
    <div class="app-main__inner">
        ...
        <div class="main-card card">
            <div class="card-header">
                <a href="{{ route('kelas.pgtk.edit.kelas', [$bulanTerbaru->id, $kelas->id]) }}" class="btn btn-primary">
                    {{ $dataKesehatan->isEmpty() ? 'Tambah Data' : 'Update Data' }}
                </a>
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                    @foreach ($bulan_spp as $bulan)
                        <li>
                            <a href="{{ route('kelas.pgtk.detail.kelas', [$bulan->id, $kelas->id]) }}"
                                class="dropdown-item">
                                {{ $bulan->nama_bulan }}
                            </a>
                        </li>
