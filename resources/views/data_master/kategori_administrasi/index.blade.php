    ...
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Kategori Administrasi
                        <div class="page-title-subheading">
                            Merupakan kategori untuk pengelompokan administrasi
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="main-card card">
            <div class="card-header">
                <a href="{{ route('kategori-administrasi.create') }}" class="btn btn-primary">Tambah Baru</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @forelse ($kategori as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->jenis }}</td>
                                    <td>
                                        {{ $item->semester == 1 ? 'Ya' : 'Tidak' }}
                                    </td>
                                    <td class="d-flex">
                                        <a href="{{ route('kategori-administrasi.edit', $item->id) }}"
                                            class="btn btn-sm btn-primary mx-1"><i class="pe-7s-note"
                                                style="font-size: 0.85rem;"></i></a>

                                        <form action="{{ route('kategori-administrasi.destroy', $item->id) }}"
