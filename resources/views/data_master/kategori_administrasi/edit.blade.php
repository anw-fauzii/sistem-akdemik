...
@section('content')
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Edit Kategori Administasi
                        <div class="page-title-subheading">
                            Mengedit Kategori Administasi yang ada
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="main-card card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('kategori-administrasi.update', $kategori->id) }}" id="createForm">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="position-relative form-group">
                                ...
                                <select name="jenis" id="jenis"
                                    ...
                                    <option value="guru" {{ old('jenis', $kategori->jenis) == 'guru' ? 'selected' : '' }}>Guru
                                    </option>
                                    <option value="kelas" {{ old('jenis', $kategori->jenis) == 'kelas' ? 'selected' : '' }}>Kelas
                                    </option>
                                </select>
                                @error('jenis')
                                    <div class="invalid-feedback" style="font-style: italic; font-size: 0.7rem;">
                        ...
                        <div class="col-md-12">
                            <div class="position-relative form-group">
                                ...
                                <select name="semester" id="semester"
                                    ...
                                    <option value="1" {{ old('semester', $kategori->semester) == '1' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="0" {{ old('semester', $kategori->semester) == '0' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                                @error('semester')
                                    <div class="invalid-feedback" style="font-style: italic; font-size: 0.7rem;">
