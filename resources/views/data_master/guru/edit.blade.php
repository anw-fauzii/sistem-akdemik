...
<div class="app-main__inner">
    ...
    <div class="main-card card">
        ...
        <div class="card-body">
            <form  method="post" action="{{route('guru.update', $guru->id)}}" id="createForm">
                @csrf
                @method('PUT')
                <div class="form-row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="tempat_lahir" id="tempat_lahir" placeholder="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ $guru->tempat_lahir ?? old('tempat_lahir') }}">
                            @error('tempat_lahir')
                                <div class="invalid-feedback" style="font-style: italic; font-size: 0.7rem;">
                                    {{ strtolower($message) }}
                                </div>
