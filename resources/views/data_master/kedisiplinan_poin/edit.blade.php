...
@section('title')
    <title>Edit Aturan Kedisiplinan</title>
@endsection
...
@section('content')
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Edit Aturan Kedisiplinan
                        <div class="page-title-subheading">
                            Mengubah data aturan kedisiplinan yang sudah ada
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="main-card card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('kedisiplinan-poin.update', $kedisiplinanPoin->id) }}" id="editForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-12">
                            <div class="position-relative form-group">
                                ...
                                <input name="nama_aturan" id="nama_aturan" placeholder="Contoh: Terlambat masuk sekolah"
                                    ...
                                    value="{{ old('nama_aturan', $kedisiplinanPoin->nama_aturan) }}">
                                @error('nama_aturan')
                            ...
                            <div class="position-relative form-group">
                                ...
                                <select name="kategori" id="kategori"
                                    ...
                                    <option value="pelanggaran"
                                        {{ old('kategori', $kedisiplinanPoin->kategori) == 'pelanggaran' ? 'selected' : '' }}>
                                        Pelanggaran</option>
                                    <option value="prestasi"
                                        {{ old('kategori', $kedisiplinanPoin->kategori) == 'prestasi' ? 'selected' : '' }}>
                                        Prestasi</option>
                                </select>
                                @error('kategori')
                                    <div class="invalid-feedback" style="font-style: italic; font-size: 0.7rem;">
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group">
                                ...
                                <select name="tingkat" id="tingkat"
                                    ...
                                    <option value="ringan"
                                        {{ old('tingkat', $kedisiplinanPoin->tingkat) == 'ringan' ? 'selected' : '' }}>
                                        Ringan</option>
                                    <option value="sedang"
                                        {{ old('tingkat', $kedisiplinanPoin->tingkat) == 'sedang' ? 'selected' : '' }}>
                                        Sedang</option>
                                    <option value="berat"
                                        {{ old('tingkat', $kedisiplinanPoin->tingkat) == 'berat' ? 'selected' : '' }}>Berat
                                    </option>
                                </select>
                                @error('tingkat')
                                    <div class="invalid-feedback" style="font-style: italic; font-size: 0.7rem;">
                        ...
                        <div class="col-md-12">
                            <div class="position-relative form-group">
                                ...
                                <input name="poin" id="poin" placeholder="Contoh: 10" type="number"
                                    ...
                                    value="{{ old('poin', $kedisiplinanPoin->poin) }}">
                                @error('poin')
                                    <div class="invalid-feedback" style="font-style: italic; font-size: 0.7rem;">
                                        {{ strtolower($message) }}
                                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <a href="{{ route('kedisiplinan-poin.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
