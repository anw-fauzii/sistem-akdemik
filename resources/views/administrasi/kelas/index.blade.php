                ...
                <div class="page-title-heading">
                    ...
                    <div>Administrasi Kelas
                        <div class="page-title-subheading">
                            Daftar administrasi kelas yang telah diunggah
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="mb-0 table table-hover table-striped" id="myTable2">
                        ...
                        <tbody>
                            ...
                            @forelse ($kategori as $item)
                                @php
                                    // SABUK PENGAMAN (Null Coalescing Fallback) + CamelCase
                                    $files = $item->administrasiKelas ?? ($item->administrasi_kelas ?? collect());
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelectorAll('.delete-button').forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        title: 'Konfirmasi',
                        text: 'Apakah yakin file ini akan dihapus dari Google Drive?',
                        icon: 'warning',
